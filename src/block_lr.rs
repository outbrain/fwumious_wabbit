...
impl<L: OptimizerTrait + 'static> BlockTrait for BlockLR<L> {
    ...
    fn forward_backward(
        ...
        unsafe {
            ...
            let (prediction_probability, general_gradient) = next_regressor[0].forward_backward(
                further_regressors,
                wsum_input + wsum,
                fb,
                update,
    ...
    fn forward(
        ...
        let prediction_probability =
            next_regressor[0].forward(further_blocks, wsum + wsum_input, fb);
