...
"#;
        ...
        let fbuf = &lr_vec(vec![HashAndValue{hash: 1, value: 1.0, bin_value: Option::Some(1.0)}, HashAndValue{hash:2, value: 1.0, bin_value: Option::Some(1.0)}]);
...
"#;
        ...
        let fbuf = &ffm_vec(vec![
                                  HashAndValueAndSeq{hash:1, value: 1.0, contra_field_index: 0, bin_value: Option::Some(1.0)},
                                  HashAndValueAndSeq{hash:3 * 1000, value: 1.0, contra_field_index: 0, bin_value: Option::Some(1.0)},
                                  HashAndValueAndSeq{hash:100, value: 2.0, contra_field_index: 1, bin_value: Option::Some(1.0)}
                                  ], 2);
...
"#;
        ...
        let fbuf_1 = &lr_and_ffm_vec(
                                vec![HashAndValue{hash: 52, value: 0.5, bin_value: Option::Some(1.0)}, HashAndValue{hash:2, value: 1.0, bin_value: Option::Some(1.0)}],
                                vec![
                                  HashAndValueAndSeq{hash:1, value: 0.5, contra_field_index: 0, bin_value: Option::Some(1.0)},
                                  HashAndValueAndSeq{hash:3 * 1000, value: 1.0, contra_field_index: 0, bin_value: Option::Some(1.0)},
                                  HashAndValueAndSeq{hash:101, value: 2.0, contra_field_index: 1, bin_value: Option::Some(1.0)}
                                  ], 2);
        let fbuf_2 = &lr_and_ffm_vec(
                                vec![HashAndValue{hash: 1, value: 1.0, bin_value: Option::Some(1.0)}, HashAndValue{hash:2, value: 1.0, bin_value: Option::Some(1.0)}],
                                vec![
                                  HashAndValueAndSeq{hash:1, value: 1.0, contra_field_index: 0, bin_value: Option::Some(1.0)},
                                  HashAndValueAndSeq{hash:3 * 1000, value: 1.0, contra_field_index: 0, bin_value: Option::Some(1.0)},
                                  HashAndValueAndSeq{hash:100, value: 2.0, contra_field_index: 1, bin_value: Option::Some(1.0)}
