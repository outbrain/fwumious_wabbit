...
pub fn create_expected_args<'a>() -> App<'a, 'a> {
    App::new("fwumious wabbit")
        ...
        .arg(Arg::with_name("ffm_learning_rate")
             ...
             .help("Learning rate")
             .takes_value(true))
        .arg(Arg::with_name("ffm_beta1")
             .long("ffm_beta1")
             .value_name("0.12")
             .help("Beta1 - ffm part")
             .takes_value(true))
        .arg(Arg::with_name("ffm_beta2")
             .long("ffm_beta2")
             .value_name("0.12")
             .help("Beta2 - ffm part")
             .takes_value(true))
        .arg(Arg::with_name("nn_beta1")
             .long("nn_beta1")
             .value_name("0.12")
             .help("Beta1 - nn part")
             .takes_value(true))
        .arg(Arg::with_name("nn_beta2")
             .long("nn_beta2")
             .value_name("0.15")
             .help("Beta2 - nn part")
             .takes_value(true))
        .arg(Arg::with_name("beta1")
             .long("beta1")
             .value_name("0.12")
             .help("Beta1 - lr part")
             .takes_value(true))
        .arg(Arg::with_name("beta2")
             .long("beta2")
             .value_name("0.15")
             .help("Beta2 - lr part")
             .takes_value(true))	
