...
pub fn parse<'a>() -> clap::ArgMatches<'a> {
  let matches = App::new("fwumious wabbit")
                    ...
                    .arg(Arg::with_name("attention_init_acc_gradient")
                     .long("attention_init_acc_gradient")
                     .help("Adagrad initial accumulated gradient for attention")
                     .multiple(false)
                     .takes_value(true))
                    .arg(Arg::with_name("attention_snap_to_zero")
                     .long("attention_snap_to_zero")
                     .help("Attention snap to zero threshold")
                     .multiple(false)
                     .takes_value(true))
                    .arg(Arg::with_name("attention_learning_rate")
                     .long("attention_learning_rate")
                    ...
                    .arg(Arg::with_name("attention_power_t")
                     ...
                     .multiple(false)
                     .takes_value(true))
                    .arg(Arg::with_name("attention_l2")
                     .long("attention_l2")
                     .help("Attention L2 regularization")
                     .multiple(false)
                     .takes_value(true))
