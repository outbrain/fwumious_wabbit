...
pub fn create_expected_args<'a>() -> App<'a, 'a> {
    ...
    // Regressor
        ...
        .arg(Arg::with_name("ffm_k")
             ...
             .takes_value(true))
		.arg(Arg::with_name("ffm_mc_iteration_count")
			.long("ffm_mc_iteration_count")
			.help("Number of Monte Carlo iterations to run")
			.takes_value(true))
		.arg(Arg::with_name("ffm_mc_dropout_rate")
			.long("ffm_mc_dropout_rate")
			.help("Dropout rate for Monte Carlo after FFM")
			.takes_value(true))
