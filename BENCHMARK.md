...
----|----:|----:|----:
vw train, no cache|100.30 | 564 | 173.93
fw train, no cache|18.81 | 258 | 101.80
vw train, using cache|103.99 | 567 | 168.10
fw train, using cache|12.84 | 258 | 101.77
vw predict, no cache|84.07 | 141 | 178.77
fw predict, no cache|15.90 | 130 | 100.93
...
fwumious wabbit 0.2 (git commit: 49366eb)
```
