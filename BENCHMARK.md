...
----|----:|----:|----:
vw train, no cache|102.05 | 573 | 173.20
fw train, no cache|15.47 | 259 | 101.70
vw train, using cache|105.24 | 566 | 167.60
fw train, using cache|13.37 | 259 | 102.27
vw predict, no cache|84.16 | 141 | 178.60
fw predict, no cache|12.28 | 131 | 101.83
...
fwumious wabbit 0.1 (git commit: 365f44f)
```
