...
----|----:|----:|----:
vw train, no cache|102.86 | 562 | 173.00
fw train, no cache|14.27 | 258 | 101.80
vw train, using cache|99.37 | 567 | 168.93
fw train, using cache|13.65 | 258 | 102.20
vw predict, no cache|82.47 | 141 | 179.40
fw predict, no cache|11.33 | 130 | 100.93
...
fwumious wabbit 0.3 (git commit: 42a0a23)
```
