...
#namespaces="--keep B --interactions 4G --interactions 4GHX --interactions 4GUW --interactions 4K --interactions 4c"
#namespaces="--keep B --interactions 4K --interactions 4c"
#namespaces="--keep A --interactions 4K"
rest="--data $infile -l 0.025 -b 24 --adaptive --sgd --link=logistic --loss_function logistic --power_t 0.39 --l2 0.0 --hash all"
