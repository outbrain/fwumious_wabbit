...
cargo build --release && \
target/release/fw $namespaces $rest -c -p f $fwonly --prediction_model_delay 2 --prediction_model_delay_examples_per_switch 100000 && time $vw $namespaces $rest -c -p v $vwonly
