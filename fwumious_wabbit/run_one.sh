...
namespaces="--keep A"
rest="--data $infile -l 0.025 --adaptive --sgd --loss_function logistic --power_t 0.0 --l2 0.0 --hash all --noconstant"
...
echo "cargo build --release && target/release/fw $namespaces $rest -c -p f -i regressor.fw && time $vw $namespaces $rest -c -p v -i regressor.vw"

cargo build --release && target/release/fw $namespaces $rest -c -p f -i regressor.fw && time $vw $namespaces $rest -c -p v -i regressor.vw
