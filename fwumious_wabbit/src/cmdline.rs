...
pub fn parse<'a>() -> clap::ArgMatches<'a> {
  ...
  let matches = App::new("fwumious wabbit")
                    ...
                    .arg(Arg::with_name("prediction_model_delay")
                     ...
                     .value_name("number_of_models (=0")
                     .help("with how old past model should the outputted predictions be made")
                     .takes_value(true))
                    .arg(Arg::with_name("prediction_model_delay_examples_per_switch")
                     .long("prediction_model_delay_examples_per_switch")
                     .value_name("examples (=100000")
                     .help("Every how many examples to switch the delayed model")
                     .takes_value(true))
