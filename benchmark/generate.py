...
def render_example(a, b):
    score = get_score(a, b)
    return " ".join([str(score), u"|A", ADICT[a[0]] + u"-" + str(a[1]), u"|B", BDICT[b[0]] + u"-" + str(b[1])]) + random_features() + "\n"
...
if __name__ == "__main__":
    ...
    generate(Path(""), dataset_size, dataset_size, 1000)
